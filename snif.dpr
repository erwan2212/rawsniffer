...
const DLT_EN10MB      =1;
begin
AssignFile(FromF, 'dump'+formatdatetime('hh-nn-ss-', now)+'.cap');
Rewrite (FromF,1);
...
begin
writeln('raw sniffer 0.1 by erwan2212@gmail.com');
writeln('snif [localip] [proto] [port] [0:1]');
...
if (paramcount>=4) and (lowercase(paramstr(4))='1') then cap:=true;
